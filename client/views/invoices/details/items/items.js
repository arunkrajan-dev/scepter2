...
Template.InvoicesDetailsItemsView.events({
	...
	"click #dataview-insert-button": function(e, t) {
		e.preventDefault();
		Router.go("invoices.details.insert", {invoiceId: this.params.invoiceId, account: this.params.account});
	},
...
Template.InvoicesDetailsItemsViewTableItems.events({
	...
	"click #edit-button": function(e, t) {
		e.preventDefault();
		Router.go("invoices.details.edit", {invoiceId: UI._parentData(1).params.invoiceId, account: UI._parentData(1).params.account, itemId: this._id});
		return false;
	}
});
