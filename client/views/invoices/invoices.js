...
var InvoicesViewExport = function(cursor, fileType) {
	...
	var exportFields = ["invoiceNumber", "date", "member.name", "totalAmount"];
...
Template.InvoicesView.events({
	...
	"click #dataview-insert-button": function(e, t) {
		e.preventDefault();
		Router.go("invoices.insert", {account: this.params.account});
	},
...
Template.InvoicesViewTableItems.events({
	...
	"click #edit-button": function(e, t) {
		e.preventDefault();
		Router.go("invoices.edit", {invoiceId: this._id, account: this.account});
		return false;
	},
